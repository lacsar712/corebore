...
func (s *Sink) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	rec := Received{
		...
		EventID:       r.Header.Get("X-Core-Event-Id"),
		DeliveryID:    r.Header.Get("X-Core-Delivery-Id"),
		Attempt:       r.Header.Get("X-Core-Attempt"),
		DestinationID: r.Header.Get("X-Core-Destination"),
	}
	keep := []string{
		"Content-Type",
		"X-Core-Timestamp",
