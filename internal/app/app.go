...
import (
	...
	"github.com/lacsar712/corebore/internal/accept"
	"github.com/lacsar712/corebore/internal/backoff"
	"github.com/lacsar712/corebore/internal/clock"
	"github.com/lacsar712/corebore/internal/config"
	...
	"github.com/lacsar712/corebore/internal/idempotency"
	"github.com/lacsar712/corebore/internal/ingest"
	"github.com/lacsar712/corebore/internal/journal"
	"github.com/lacsar712/corebore/internal/loopback"
	"github.com/lacsar712/corebore/internal/nonce"
	"github.com/lacsar712/corebore/internal/queue"
	"github.com/lacsar712/corebore/internal/replay"
	"github.com/lacsar712/corebore/internal/runtime"
	"github.com/lacsar712/corebore/internal/store"
	"github.com/lacsar712/corebore/internal/worker"
)
...
func New(cfg config.Config) (*App, error) {
	...
	a.Engine = worker.New(clk, a.Broker, a.Dests, a.Gates, lab.New(10*time.Second), a.Log, a.Dead, backoff.Default())
